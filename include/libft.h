...
void ft_lstadd_front(t_list **lst, t_list *new_node);                    // adds a new element to the front of the list
void ft_lstadd_back(t_list **lst, t_list *new_node);                     // adds a new element to the back of the list

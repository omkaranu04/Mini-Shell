...
/*
    Custom library for the minishell, mimicking the C standard library.
    t_list : for dynamic data storage of required things, in a linked list manner
    Rest all are function declarations
*/
